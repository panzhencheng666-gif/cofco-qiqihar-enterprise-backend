...
assert_contains "GRANT SELECT ON ALL TABLES IN SCHEMA risk TO qiqihar_risk_runtime"
assert_contains "risk.training_schedule_execution"
assert_contains "risk.model_version"
assert_contains 'ALTER DEFAULT PRIVILEGES FOR ROLE :"migration_owner" IN SCHEMA risk'
...
assert_not_contains "GRANT SELECT,INSERT,UPDATE ON ALL TABLES IN SCHEMA risk"
assert_not_contains "GRANT SELECT,INSERT,UPDATE ON TABLES TO qiqihar_risk_runtime"
