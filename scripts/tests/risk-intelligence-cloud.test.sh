...
assert_contains "$deploy_script" 'V220__create_expert_sft_queue.sql \'
assert_contains "$deploy_script" 'V221__grant_expert_queue_risk_runtime.sql; do'
...
assert_contains "$bundle_script" 'V220__create_expert_sft_queue.sql \'
assert_contains "$bundle_script" 'V221__grant_expert_queue_risk_runtime.sql; do'
...
assert_contains "$runner" "version in ('214','215','216','217','218','219','220')"
