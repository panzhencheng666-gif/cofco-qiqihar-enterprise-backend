...
class DesignSampleMetadataMigrationIntegrationTest {
    ...
    void migratesAnImmutableDigestBoundCatalogWithRuntimeReadOnlyAccess() {
        ...
        assertThat(count(jdbc, "platform.design_sample_domain_definition")).isEqualTo(8);
        assertThat(count(jdbc, "platform.design_sample_product_definition")).isEqualTo(11);
        assertThat(count(jdbc, "platform.design_sample_object_type_definition")).isEqualTo(35);
        assertThat(count(jdbc, "platform.design_sample_context")).isEqualTo(83);
        ...
        jdbc.sql("""
                ...
                VALUES ('design-sample-fields-v4',
        ...
        jdbc.sql("""
                ...
                VALUES ('design-sample-fields-v4', 'FUTURE', '未来域', '未启用合同', '[]', 999)
                """).update();
